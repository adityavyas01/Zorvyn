...
function Login() {
  ...
  return (
    <PageLayout
      title="Login"
      description="Secure login to access your financial dashboard and records."
    >
      <div className="mx-auto w-full max-w-lg">
        ...
        <form onSubmit={onSubmit} className="grid gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              {isSubmitting && (
                <span className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-slate-700 border-r-transparent" />
              )}
        ...
        {statusMessage && <p className="mt-3 text-sm text-slate-700 dark:text-slate-200">{statusMessage}</p>}

        <section className="mt-4 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 dark:border-slate-700 dark:bg-slate-900/55">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Demo Access</p>
          <ul className="mt-2 space-y-1.5 text-xs text-slate-600 dark:text-slate-300 sm:text-sm">
            <li>
              <span className="font-semibold text-slate-800 dark:text-slate-200">Admin:</span>{" "}
              <span className="font-mono">admin.demo@example.com</span> |{" "}
              <span className="font-mono">AdminDemo123!</span>
            </li>
            <li>
              <span className="font-semibold text-slate-800 dark:text-slate-200">Analyst:</span>{" "}
              <span className="font-mono">analyst.demo@example.com</span> |{" "}
              <span className="font-mono">AnalystDemo123!</span>
            </li>
            <li>
              <span className="font-semibold text-slate-800 dark:text-slate-200">Viewer:</span>{" "}
              <span className="font-mono">viewer.demo@example.com</span> |{" "}
              <span className="font-mono">ViewerDemo123!</span>
            </li>
          </ul>
        </section>
        ...
        <p className="mt-6 text-xs text-slate-500 dark:text-slate-400">
          Built with Node.js, MongoDB, Redis, React
        </p>
      </div>
    </PageLayout>
  );
